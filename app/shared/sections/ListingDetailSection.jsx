    ...
    const handleBookNow = () => {
        if (!session) {
            ...
            const queryParams = new URLSearchParams({
                post_id: detailData.id,
                start_date: selectedDates[0] ? selectedDates[0].toISOString().split('T')[0] : '',
                end_date: selectedDates[1] ? selectedDates[1].toISOString().split('T')[0] : '',
                adults: counters.adultsCount,
                teenagers: counters.teenagersCount,
                kids: counters.kidsCount,
                pets: counters.petsCount,
            }).toString();
                ...
                <div className="container">
                    <div className="row">
                        ...
                        >
                            ...
                            >
                                {['adultsCount', 'teenagersCount', 'kidsCount', 'petsCount'].map((type) => (
                                    <div className="row justify-content-between align-items-center" key={type}>
                                        <div className="col-6">
                                            <h6 className="list-title">{type.replace('Count', '')}</h6>
                                        </div>
